...
// Setup program for the WTL App Wizard for VC++ 11.0 Express
...
function main()
{
	...
	try
	{
		var strVCKey = "HKLM\\Software\\Microsoft\\VCExpress\\11.0\\Setup\\VC\\ProductDir";
	...
	catch(e)
	{
		try
		{
			var strVCKey_x64 = "HKLM\\Software\\Wow6432Node\\Microsoft\\VCExpress\\11.0\\Setup\\VC\\ProductDir";
			strValue = WSShell.RegRead(strVCKey_x64);
		}
		catch(e)
		{
			WScript.Echo("ERROR: Cannot find where Visual C++ 11.0 Express is installed.");
			return;
		}
	}
